...
function UICheckBox({ selected = false, onChanged, label, labelStyle, style, disabled = false, size = "medium", }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, Object.assign({ onPress: handlePress, style: [styles.container, style], disabled: disabled, activeOpacity: 0.7 }, { children: (0, jsx_runtime_1.jsxs)(components_1.Row, Object.assign({ crossAxisAlignment: "center", separator: (0, jsx_runtime_1.jsx)(components_1.HorizontalSpacing, { size: styles_1.spacing.sm }) }, { children: [(0, jsx_runtime_1.jsx)(react_native_1.View, Object.assign({ style: [
                        styles.checkbox,
                        styles[size],
                        selected && styles.selected,
                        disabled && styles.disabled,
                    ] }, { children: icon })), label && ((0, jsx_runtime_1.jsx)(components_1.Expanded, { children: (0, jsx_runtime_1.jsx)(react_native_1.Text, Object.assign({ style: [
                            styles.label,
                            styles[`${size}Label`],
