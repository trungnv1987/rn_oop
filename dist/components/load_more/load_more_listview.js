...
function LoadMoreListView({ controller, itemBuilder, keyExtractor, showsScrollIndicator, contentContainerStyle, separator, couldRefresh = true, }) {
    ...
    const heightCache = (0, react_1.useRef)({}).current;
    ...
    const layoutProvider = (0, react_1.useMemo)(() => new recyclerlistview_1.LayoutProvider(() => "ROW", (_type, dim, index) => {
        var _a;
        dim.width = width;
        dim.height = (_a = heightCache[index]) !== null && _a !== void 0 ? _a : 60; // default guess
    }), [width]);
