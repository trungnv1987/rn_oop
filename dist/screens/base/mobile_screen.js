...
function MobileScreen({ viewModel, viewModelContext, children, }) {
    return ((0, jsx_runtime_1.jsxs)(react_oop_1.AppScreen, Object.assign({ viewModel: viewModel, viewModelContext: viewModelContext }, { children: [(0, jsx_runtime_1.jsx)(react_native_1.KeyboardAvoidingView, Object.assign({ style: { flex: 1 }, behavior: "padding" }, { children: children })), (0, jsx_runtime_1.jsx)(ui_dialog_1.UIDialog, { controller: viewModel.dialogController })] })));
}
