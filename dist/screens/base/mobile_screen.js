...
function MobileScreen({ viewModel, viewModelContext, children, avoidKeyboard = true, keyboardVerticalOffset = 0, }) {
    ...
    if (avoidKeyboard) {
        return ((0, jsx_runtime_1.jsx)(react_native_1.KeyboardAvoidingView, Object.assign({ style: { flex: 1 }, behavior: behavior, keyboardVerticalOffset: keyboardVerticalOffset }, { children: screen })));
    }
    return screen;
}
